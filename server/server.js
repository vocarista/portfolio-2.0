...
app.use(cors({
    origin: ['http://localhost:5173', 'http://localhost:4173', 'http://vocarista.com', 'https://dev.vocarista.com', 'https://www.vocarista.com', 'https://portfolio-full-stack.onrender.com/'],
